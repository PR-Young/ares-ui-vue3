<template>
  ...
  <el-alert v-if="props.data.description" type="info">{{
  ...
  <el-form-item
    label="默认值"
    v-if="
      props.data.layout !== 'rowFormItem' &&
      props.data.layout !== undefined &&
      !props.data.customDefaultValue
    "
  >
    <el-input
      v-if="props.data.tag === 'my-text'"
  ...
  <el-form-item
    v-if="props.data['start-placeholder'] !== undefined"
    label="开始占位"
  >
    <el-input
      v-model="props.data['start-placeholder']"
      placeholder="请输入占位提示"
    />
  </el-form-item>
  <el-form-item
    v-if="props.data['end-placeholder'] !== undefined"
    label="结束占位"
  >
    <el-input
      v-model="props.data['end-placeholder']"
      placeholder="请输入占位提示"
    />
  </el-form-item>
  ...
  <el-form-item
    v-if="
      ...
      (props.data.optionType === 'button' ||
        props.data.border ||
        props.data.tag === 'el-color-picker' ||
        props.data.tag === 'el-button')
    "
    label="组件尺寸"
  >
  ...
  <el-form-item
    v-if="props.data['show-word-limit'] !== undefined"
    label="输入统计"
  >
  ...
  <el-form-item v-if="props.data.required !== undefined" label="是否必填">
    <el-switch
      ...
      :disabled="!props.couldChangeRequire"
    />
    <el-tooltip class="item" effect="dark" placement="top-start">
      ...
      <span v-show="props.data.proCondition" style="font-size:12px;color#aaa;"
        >&nbsp;(勾选后可作为流程条件)</span
      >
    </el-tooltip>
  </el-form-item>
  ...
  <el-form-item v-if="props.data.labelWidth !== undefined" label="标签宽度">
    <el-input-number
      v-model.number="props.data.labelWidth"
      placeholder="请输入标签宽度"
    />
  </el-form-item>
  <el-form-item
    v-if="props.data.style && props.data.style.width !== undefined"
    label="组件宽度"
  >
    <el-input
      v-model="props.data.style.width"
      placeholder="请输入组件宽度"
      clearable
    />
  </el-form-item>
