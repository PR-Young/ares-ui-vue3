<template >
  <el-form-item v-if="props.data.type !== undefined" label="时间类型">
    <el-select
  ...
  <el-form-item
    v-if="props.data['range-separator'] !== undefined"
    label="分隔符"
  >
    <el-input
      v-model="props.data['range-separator']"
      placeholder="请输入分隔符"
    />
  </el-form-item>
  <el-form-item
    v-if="props.data['picker-options'] !== undefined"
    label="时间段"
  >
    <el-input
      v-model="props.data['picker-options'].selectableRange"
      placeholder="请输入时间段"
    />
  </el-form-item>
  ...
  <el-form-item
    v-if="props.data['showDuration'] !== undefined"
    label="计算时长"
  >
    <el-switch
      v-model="props.data['showDuration']"
      placeholder="自动计算时长"
...
const dateOptions = computed(() => {
  if (
    ...
    ["el-date-picker", "ai-date-duration"].includes(props.data.tag)
  ) {
