...
export function getQueueBindings(params: any) {
  return request({
...
export function addExchange(data: any) {
  return request({
...
export function deleteExchange(params: any) {
  return request({
...
export function deleteQueue(params: any) {
  return request({
...
export function purgeQueue(params: any) {
  return request({
...
export function removeBinding(params: any) {
  return request({
